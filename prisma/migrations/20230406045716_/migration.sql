...
INSERT INTO "new_transactions" ("attachment", "category", "created_at", "description", "id", "user_id", "value", "wallet_id") SELECT "attachment", "category", "created_at", "description", "id", "user_id", "value", "wallet_id" FROM "transactions";
